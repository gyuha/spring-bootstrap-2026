...
- ✅ **v1.1 인증 웹 인터페이스** — Phase 5~6 (shipped 2026-05-31) — 상세: [milestones/v1.1-ROADMAP.md](./milestones/v1.1-ROADMAP.md)
...
<details>
<summary>✅ v1.1 인증 웹 인터페이스 (Phase 5~6) — SHIPPED 2026-05-31</summary>

- [x] Phase 5: BFF 인증 세션 엔드포인트 (3/3 plans) — `/api/auth/session`·`/logout`(204)·`/login`(returnTo, open-redirect 방지) + SecurityConfig
- [x] Phase 6: 내 정보 신원·권한 집계 (3/3 plans) — `/api/auth/me` Identity+Authorization(direct) 교차 집계, ArchUnit 무변경 GREEN

전체 Phase 상세(Goal/SC/Plans)는 `milestones/v1.1-ROADMAP.md`에 아카이브됨.
...
| 5. BFF 인증 세션 엔드포인트 | v1.1 | 3/3 | Complete | 2026-05-31 |
| 6. 내 정보 신원·권한 집계 | v1.1 | 3/3 | Complete | 2026-05-31 |
